...
public class AppString {
	...
	private AppString() {
		...
		dataMap.put(1018, "請選擇是否使用引導模式？(y/n，選擇「否」將切換至專家模式，預設為「是」(y))");
		dataMap.put(1019, "\n轉檔作業已完成...\n請選擇是否繼續執行？(y/n，預設為「否」(n))");
		dataMap.put(1020, "開始切換至專家模式...\n");
		dataMap.put(1021, "開始切換至引導模式...\n");
		dataMap.put(1022, "現在，請直接輸入所需參數，格式為：\n"
				+ "「輸入檔案路徑, 輸出檔案路徑, 輸入編碼, 輸出編碼, 是否允許覆蓋檔案(布林值)」或"
				+ "\n「輸入檔案路徑, 輸出檔案路徑, 轉換模式(1.0~6.0), 是否允許覆蓋檔案(布林值)」"
				+ "\n，至少要填入「輸入檔案路徑」，參數間請以「,」隔開：");
		dataMap.put(1023, "\n程式已停止...");
		dataMap.put(1024, "參數數量過多或不足，請重新輸入！\n");
	}
